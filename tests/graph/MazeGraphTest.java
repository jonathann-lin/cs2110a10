...
public class MazeGraphTest {
    ...
    @DisplayName(
            "WHEN a GameMap contains vertices in all 4 corners of the game map, their edges are"
                    + " correctly connected")
    @Test
    void testCornerTunneling() {
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][0], map.elevations()[5][0]),
                e00_left.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][0], map.elevations()[0][3]),
                e00_up.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[5][0], map.elevations()[0][0]),
                e50_right.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[5][0], map.elevations()[5][3]),
                e50_up.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][3], map.elevations()[0][2]),
                e03_up.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][3], map.elevations()[5][3]),
                e03_left.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][3], map.elevations()[0][0]),
                e03_down.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[5][3], map.elevations()[5][0]),
                e53_down.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[5][3], map.elevations()[0][3]),
                e53_right.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][2], map.elevations()[0][3]),
                e02_down.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][2], map.elevations()[1][2]),
                e02_right.weight());
        ...
        assertEquals(MazeGraph.edgeWeight(map.elevations()[1][2], map.elevations()[0][2]),
                e12_left.weight());
    ...
    @DisplayName("WHEN a GameMap contains vertices in only two corners of the game map,"
            + "THEN only the correct edges are created.")
    @Test
    void testPartialCornerTunneling() {
        GameMap map = createMap("""
                pwwwww
                pwwwww
                pppwwp
        ...
        IPair p12 = new IPair(1, 2);
        IPair p22 = new IPair(2, 2);
        IPair p52 = new IPair(5, 2);

        assertTrue(vertices.containsKey(p00));
        assertTrue(vertices.containsKey(p01));
        assertTrue(vertices.containsKey(p02));
        assertTrue(vertices.containsKey(p03));
        assertTrue(vertices.containsKey(p12));
        assertTrue(vertices.containsKey(p22));
        assertTrue(vertices.containsKey(p52));

        MazeVertex v00 = vertices.get(p00);
        MazeVertex v01 = vertices.get(p01);
        MazeVertex v02 = vertices.get(p02);
        MazeVertex v03 = vertices.get(p03);
        MazeVertex v12 = vertices.get(p12);
        MazeVertex v22 = vertices.get(p22);
        MazeVertex v52 = vertices.get(p52);
        ...
        MazeEdge e00_down = v00.edgeInDirection(Direction.DOWN);
        assertNotNull(e00_down);
        assertEquals(v00, e00_up.tail());
        assertEquals(v03, e00_up.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][0], map.elevations()[0][1]),
                e00_down.weight());

        assertNull(v00.edgeInDirection(Direction.RIGHT));
        assertNull(v00.edgeInDirection(Direction.LEFT));
        ...
        //Check to make sure that nonexistent points don't exist
        IPair p50 = new IPair(5, 0);
        IPair p53 = new IPair(5, 3);
        assertFalse(vertices.containsKey(p50));
        assertFalse(vertices.containsKey(p53));

        // --- Vertex 02 ---
        MazeEdge e02_up = v02.edgeInDirection(Direction.UP);
        assertNotNull(e02_up);
        assertEquals(v02, e02_up.tail());
        assertEquals(v01, e02_up.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][2], map.elevations()[0][1]),
                e02_up.weight());
        ...
        MazeEdge e02_left = v02.edgeInDirection(Direction.LEFT);
        assertNotNull(e02_left);
        assertEquals(v02, e02_left.tail());
        assertEquals(v52, e02_left.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][2], map.elevations()[5][2]),
                e02_left.weight());
    ...
    @DisplayName(
            "WHEN a GameMap contains a path tile in a corner that has tiles in all four directions"
                    + "THEN the edges are correctly formed.")
    @Test
    void testCornerAllDirections() {
        GameMap map = createMap("""
                pwwww
                wwwww
                pwwww
        ...
        assertTrue(vertices.containsKey(p02));
        assertTrue(vertices.containsKey(p03));
        assertTrue(vertices.containsKey(p13));
        assertTrue(vertices.containsKey(p23));
        assertTrue(vertices.containsKey(p43));
        ...
        MazeVertex v02 = vertices.get(p02);
        MazeVertex v03 = vertices.get(p03);
        MazeVertex v13 = vertices.get(p13);
        MazeVertex v23 = vertices.get(p23);
        MazeVertex v43 = vertices.get(p43);
        ...
        assertNotNull(e03_left);
        assertEquals(v03, e03_left.tail());
        assertEquals(v43, e03_left.head()); // wraps around horizontally to last column
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][3], map.elevations()[4][3]),
                e03_left.weight());

        MazeEdge e03_right = v03.edgeInDirection(Direction.RIGHT);
        assertNotNull(e03_right);
        assertEquals(v03, e03_right.tail());
        assertEquals(v13, e03_right.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][3], map.elevations()[1][3]),
                e03_right.weight());

        MazeEdge e03_down = v03.edgeInDirection(Direction.DOWN);
        assertNotNull(e03_down);
        assertEquals(v03, e03_down.tail());
        assertEquals(v00, e03_down.head()); // wraps around vertically to first row
        assertEquals(MazeGraph.edgeWeight(map.elevations()[0][3], map.elevations()[0][0]),
                e03_down.weight());

    }
    @DisplayName("WHEN a GameMap contains four isolated vertices in a box, THEN the edges are connected properly.")
    @Test
    void testBox() {
        GameMap map = createMap("""
                wwww
        ...
        IPair p11 = new IPair(1, 1);
        IPair p21 = new IPair(2, 1);
        IPair p12 = new IPair(1, 2);
        IPair p22 = new IPair(2, 2);

        assertTrue(vertices.containsKey(p11));
        assertTrue(vertices.containsKey(p21));
        assertTrue(vertices.containsKey(p12));
        assertTrue(vertices.containsKey(p22));

        MazeVertex v11 = vertices.get(p11);
        MazeVertex v21 = vertices.get(p21);
        MazeVertex v12 = vertices.get(p12);
        MazeVertex v22 = vertices.get(p22);

        // --- v11 ---
        MazeEdge e11_right = v11.edgeInDirection(Direction.RIGHT);
        assertNotNull(e11_right);
        assertEquals(v11, e11_right.tail());
        assertEquals(v21, e11_right.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[1][1], map.elevations()[2][1]), e11_right.weight());

        MazeEdge e11_down = v11.edgeInDirection(Direction.DOWN);
        assertNotNull(e11_down);
        assertEquals(v11, e11_down.tail());
        assertEquals(v12, e11_down.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[1][1], map.elevations()[1][2]), e11_down.weight());

        assertNull(v11.edgeInDirection(Direction.LEFT));
        assertNull(v11.edgeInDirection(Direction.UP));

        // --- v21 ---
        MazeEdge e21_left = v21.edgeInDirection(Direction.LEFT);
        assertNotNull(e21_left);
        assertEquals(v21, e21_left.tail());
        assertEquals(v11, e21_left.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[2][1], map.elevations()[1][1]), e21_left.weight());

        MazeEdge e21_down = v21.edgeInDirection(Direction.DOWN);
        assertNotNull(e21_down);
        assertEquals(v21, e21_down.tail());
        assertEquals(v22, e21_down.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[2][1], map.elevations()[2][2]), e21_down.weight());

        assertNull(v21.edgeInDirection(Direction.RIGHT));
        assertNull(v21.edgeInDirection(Direction.UP));

        // --- v12 ---
        MazeEdge e12_up = v12.edgeInDirection(Direction.UP);
        assertNotNull(e12_up);
        assertEquals(v12, e12_up.tail());
        assertEquals(v11, e12_up.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[1][2], map.elevations()[1][1]), e12_up.weight());
        ...
        assertNull(v12.edgeInDirection(Direction.LEFT));
        assertNull(v12.edgeInDirection(Direction.DOWN));

        // --- v22 ---
        MazeEdge e22_up = v22.edgeInDirection(Direction.UP);
        assertNotNull(e22_up);
        assertEquals(v22, e22_up.tail());
        assertEquals(v21, e22_up.head());
        assertEquals(MazeGraph.edgeWeight(map.elevations()[2][2], map.elevations()[2][1]), e22_up.weight());
